# tiny_llm_2b.py — ~2B param GPT | Colab Pro A100-80GB | Rung 6
import torch, torch.nn as nn
from torch.nn import functional as F
from torch.utils.checkpoint import checkpoint

block_size, n_embd, n_head, n_layer = 128, 3232, 32, 16
lr, steps, batch_size               = 1e-4, 5000, 4
device = "cuda"
