# tiny_llm_400m.py — ~399M param GPT | Colab Pro T4
# Techniques: bf16 AMP + gradient checkpointing + grad clipping
...
# ── config ──────────────────────────────────────────────────────────
block_size, n_embd, n_head, n_layer = 128, 1664, 16, 12
lr, steps, batch_size               = 3e-4, 5000, 16
